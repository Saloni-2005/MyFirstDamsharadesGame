...
//         hints: [
//             "It starts with 'C'. it's romantic movie based on Tamil girl",
...
//         hints: [
//             "It starts with 'B'. it's an old Bollywood movie",
...
//         hints: [
//             "It starts with 'A'. it's comedy movie of Aamir Khan",
...
//             "It’s the first movie of a comedy franchise.",
//             "A lot of running around and misunderstandings.",
//             "The movie’s tagline is 'Fun Unlimited'.",
...
//     console.log(`Welcome to the Dumsaraj Game ${name}!. Guess the movie based on hints.`);
//     while (hintIndex < selectedMovie.hints.length && !guessedCorrectly) {
//         console.log(`Hint ${hintIndex + 1}: ${selectedMovie.hints[hintIndex]}`);
//         const userGuess = prompt("Your guess: ").trim().toLowerCase();
//         if (userGuess === selectedMovie.title.toLowerCase()) {
//             console.log(`Correct! The movie is "${selectedMovie.title}".`);
//             guessedCorrectly = true;
//             console.log(`Your score is: ${score}`);
//         } else {
//             hintIndex++;
//             score--;
//             if (hintIndex < selectedMovie.hints.length) {
//                 console.log("Incorrect! Here's the next hint.");
//             }
//         }
//     }
//     if (!guessedCorrectly) {
//         console.log(`Sorry, you ran out of hints! The correct movie was "${selectedMovie.title}". Try again next time.`);
//     }
//     const playAgain = prompt("Do you want to play again? (yes/no): ").trim().toLowerCase();
//     if (playAgain === "yes") {
//         playGame();
//     } else {
//         console.log("Thanks for playing Dumsaraj! Goodbye.");
//     }
// }
// playGame();
...
const prompt =require('prompt-sync')({sigint:true});
   ...
   const movies = [
    ...
    function playGame(){
        ...
        let hintIndex=0;
        let guessedCorrectly=false;
        console.log(`Welcome to the Damsaraj Game ${name} 😉. Guess the movie name`)
        while(hintIndex<selectedMovie.hints.length &&! guessedCorrectly){
            console.log(`hint ${hintIndex+1} : ${selectedMovie.hints[hintIndex]}`)
            const userGuess=prompt("Your Guess: ").trim().toLowerCase();
            if(userGuess===selectedMovie.title.toLowerCase()){
                ...
                score--;
                if(hintIndex<selectedMovie.hints.length){
                    console.log(`Incorret! Here is the next hint`)
                }
            }
        }
        if(guessedCorrectly){
